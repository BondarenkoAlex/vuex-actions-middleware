(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VuexActionsMiddleware"] = factory();
	else
		root["VuexActionsMiddleware"] = factory();
})(this, function() {
...
exports.actionsMiddleware = actionsMiddleware;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function actionsMiddleware(actions) {
  return function (mapActions) {
    return function () {
      var mapActionsOrigin = mapActions.apply(undefined, arguments);
      var args = Array.prototype.slice.call(arguments).pop();

      var objActions = {};
      args.forEach(function (key) {
        var originAction = mapActionsOrigin[key];
        objActions[key] = async function (payload) {
          var _this = this;

          var results = [];
          (0, _keys2.default)(actions).forEach(async function (keyMiddleware) {
            var action = actions[keyMiddleware];
            var promise = action.call(_this, payload);
            results.push(promise);
          });
          await _promise2.default.all(results);
